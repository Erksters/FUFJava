...
public class GoldenRatio{
    ...
    /**Global variables used to calculate the golden ratio
     * @see calcRatio() 
     */
    static double a = 0;
    static double b = 1;
   ...
   /**
     ...
     *          0, 1, 1, 2 ,3 ,4
     *                   a  b
     * @param seqLength the command line integer used to increment the global variables correctly
     */
    private static void findLastTwoValues(int seqLength){
     ...
     /**
     * This method will print of the values that are being used
     * to calculate the golden ratio
     */
